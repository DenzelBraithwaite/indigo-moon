...
<div class="container">
    ...
    <div class="flex-box">
        <div class="quote-group">
            ...
            <p class="text {theme}">{testimonial1}</p>
            <p class="author {theme}">{author1}</p>
        </div>
        ...
        <div class="quote-group">
            ...
            <p class="text {theme}">{testimonial2}</p>
            <p class="author {theme}">{author2}</p>
        </div>
        ...
        <div class="quote-group">
            ...
            <p class="text {theme}">{testimonial3}</p>
            <p class="author {theme}">{author3}</p>
        </div>
    </div>
</div>
