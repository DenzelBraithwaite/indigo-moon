...
<div class="product-wrapper">
  <img class="product-img" src="/candle-purple.webp" alt="">
  <div class="product-wrapper-right">
    <h1>Lavendar</h1>
    <h2 class="cost">8$</h2>
    <p class="description">Indulge in a little “ you time “. Have the perfect relaxing evening, preparing for a goodnight rest and sweet dreams.</p>
