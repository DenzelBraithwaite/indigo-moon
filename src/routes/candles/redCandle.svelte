...
<div class="product-wrapper">
  <img class="product-img" src="/candle-red.webp" alt="">
  <div class="product-wrapper-right">
    <h1>Red Rose</h1>
    <h2 class="cost">8$</h2>
    <p class="description">Bring love and abundance into your life, set an intention and allow your mind to manifest what you desire.</p>
